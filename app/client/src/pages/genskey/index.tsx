...
const GenSkey = () => {
    ...
    return <>
        <div className="genkey-container">
            <div>
                <div>
                    <Input onChange={onChange} style={{border: '1px solid #cac8c8', borderRadius: '4%', padding: 4}} placeholder="请输入steam用户名" value={name}></Input> 
                </div>
                <div className="button" onClick={getSkey}>生成</div>
            </div>
            {
                key && <div className="skey">
                <div id="skey" >adfjsdfi123adfasfd</div> 
