...
.adm-badge-bordered {
  border: solid 0.26667vw var(--adm-color-text-light-solid);
}
.adm-button {
  --color: var(--adm-color-text-light-solid);
...
.adm-list {
  ...
  --border-inner: solid 0.26667vw var(--adm-color-border);
  --border-top: solid 0.26667vw var(--adm-color-border);
  --border-bottom: solid 0.26667vw var(--adm-color-border);
  --padding-left: 3.2vw;
  --padding-right: 3.2vw;
...
.adm-checkbox .adm-checkbox-icon {
  flex: none;
  border: 0.26667vw solid var(--adm-color-light);
...
.adm-divider-vertical {
  ...
  vertical-align: middle;
  border-top: 0;
  border-left: 0.26667vw solid var(--adm-color-border);
}
.adm-dropdown {
  background-color: var(--adm-color-background);
}
...
.adm-dropdown-item .adm-dropdown-item-title-arrow {
  color: var(--adm-color-light);
  font-size: 2.4vw;
  transform: rotate(0deg) translateY(0.26667vw);
  transition: all ease 0.2s;
}

.adm-dropdown-item .adm-dropdown-item-title-arrow-active {
  transform: rotate(-180deg) translateY(-0.26667vw);
}
...
.adm-form {
  --border-inner: solid 0.26667vw var(--adm-border-color);
  --border-top: solid 0.26667vw var(--adm-border-color);
  --border-bottom: solid 0.26667vw var(--adm-border-color);
  --prefix-width: 6.8em;
...
.adm-popover-menu-item-text {
  ...
  border-top: solid 0.26667vw var(--border-color);
}
...
.adm-popover-menu-item:active:not(.adm-popover-menu-item-disabled)::after {
  ...
  bottom: -0.26667vw;
  left: 0;
  border-bottom: solid 0.26667vw var(--border-color);
}
...
.adm-notice-bar {
  ...
  align-items: center;
  justify-content: space-between;
  border: solid 0.26667vw var(--border-color);
  border-left: none;
  border-right: none;
  background-color: var(--background-color);
  color: var(--text-color);
...
.adm-number-keyboard-key {
  ...
  font-size: 5.86667vw;
  box-sizing: border-box;
  border: solid 0.26667vw var(--adm-color-border);
  border-bottom: none;
  border-left: none;
}
...
.adm-number-keyboard-key.adm-number-keyboard-key-extra {
  border-left: solid 0.26667vw var(--adm-color-border);
  border-right: none;
}
...
@keyframes adm-shake-horizontal {
  ...
  30% {
    transform: translateX(-0.26667vw);
  }
...
.adm-result-page-collapse {
  ...
  margin: auto;
  margin-bottom: 1.33333vw;
  border-top: 0.53333vw solid var(--adm-color-background);
  border-right: 0.53333vw solid var(--adm-color-background);
  transform: rotate(135deg);
}
...
.adm-search-bar .adm-search-bar-input-box {
  ...
  background: var(--background);
  border-radius: var(--border-radius);
  border: solid 0.26667vw transparent;
  display: flex;
  justify-content: center;
  align-items: center;
  padding-left: var(--padding-left);
...
.adm-slider-thumb {
  ...
  box-shadow: 0 0.53333vw 1.33333vw 0 rgba(0, 0, 0, 0.12);
...
.adm-slider-disabled .adm-slider-thumb {
  cursor: not-allowed;
  box-shadow: 0 0.53333vw 1.33333vw 0 rgba(0, 0, 0, 0.06);
}
...
.adm-switch-handle {
  ...
  left: var(--border-width);
  transition: all 200ms;
  box-shadow: 0 0 0.53333vw 0 rgba(0, 0, 0, 0.2), 0 0.53333vw 3.06667vw 0 rgba(0, 0, 0, 0.08), -0.26667vw 0.53333vw 0.53333vw 0 rgba(0, 0, 0, 0.1);
}
